            ...
            >
              ...
              >
                <v-row v-if="element.rating" class="position-absolute top-0 left-0 ma-2 d-flex flex-row">
                  <v-icon small v-if="element.rating < 0.5">mdi-star-outline</v-icon>
                  <v-icon small v-else-if="element.rating == 0.5">mdi-star-half-full</v-icon>
                  <v-icon small v-else>mdi-star</v-icon>
                  <v-icon small v-if="element.rating < 1.5">mdi-star-outline</v-icon>
                  <v-icon small v-else-if="element.rating == 1.5">mdi-star-half-full</v-icon>
                  <v-icon small v-else>mdi-star</v-icon>
                  <v-icon small v-if="element.rating < 2.5">mdi-star-outline</v-icon>
                  <v-icon small v-else-if="element.rating == 2.5">mdi-star-half-full</v-icon>
                  <v-icon small v-else>mdi-star</v-icon>
                  <v-icon small v-if="element.rating < 3.5">mdi-star-outline</v-icon>
                  <v-icon small v-else-if="element.rating == 3.5">mdi-star-half-full</v-icon>
                  <v-icon small v-else>mdi-star</v-icon>
                  <v-icon small v-if="element.rating < 4.5">mdi-star-outline</v-icon>
                  <v-icon small v-else-if="element.rating == 4.5">mdi-star-half-full</v-icon>
                  <v-icon small v-else>mdi-star</v-icon>
                </v-row>

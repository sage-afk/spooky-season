            ...
            >
              ...
              >
                <v-row v-if="element.rating" class="position-absolute top-0 left-0 ma-2 d-flex flex-row">
                  <v-icon v-if="element.rating < 0.5" small >mdi-star-outline</v-icon>
                  <v-icon v-else-if="element.rating == 0.5" small >mdi-star-half-full</v-icon>
                  <v-icon v-else small >mdi-star</v-icon>
                  <v-icon v-if="element.rating < 1.5" small >mdi-star-outline</v-icon>
                  <v-icon v-else-if="element.rating == 1.5" small >mdi-star-half-full</v-icon>
                  <v-icon v-else small >mdi-star</v-icon>
                  <v-icon v-if="element.rating < 2.5" small >mdi-star-outline</v-icon>
                  <v-icon v-else-if="element.rating == 2.5" small >mdi-star-half-full</v-icon>
                  <v-icon v-else small >mdi-star</v-icon>
                  <v-icon v-if="element.rating < 3.5" small >mdi-star-outline</v-icon>
                  <v-icon v-else-if="element.rating == 3.5" small >mdi-star-half-full</v-icon>
                  <v-icon v-else small >mdi-star</v-icon>
                  <v-icon v-if="element.rating < 4.5" small >mdi-star-outline</v-icon>
                  <v-icon v-else-if="element.rating == 4.5" small >mdi-star-half-full</v-icon>
                  <v-icon v-else small >mdi-star</v-icon>
                </v-row>
